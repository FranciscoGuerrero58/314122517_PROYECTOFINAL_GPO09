...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//puerta
		view = camera.GetViewMatrix();
		model = glm::translate(model, glm::vec3(1.2f, 5.35f, 14.1f));
		...
		view = camera.GetViewMatrix();
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(13.55f, 1.55f, -16.9f));
		model = glm::rotate(model, glm::radians(rot), glm::vec3(0.0f, 1.0f, 0.0));
		...
		view = camera.GetViewMatrix();
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(14.1f, 1.55f, -16.9f));
		...
		model = glm::mat4(1);
		model = glm::rotate(model, glm::radians(rot), glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::translate(model, glm::vec3(14.28f, 2.6f, -16.9));
		...
		model = glm::mat4(1);
		model = glm::rotate(model, glm::radians(rot), glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::translate(model, glm::vec3(13.38f, 2.6f, -16.9));
		...
		view = camera.GetViewMatrix();
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(27.0f, 25.99f, 16.0));
		model = glm::rotate(model, glm::radians(rot3), glm::vec3(1.0f, 0.0f, 0.0));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		bcadino.Draw(lightingShader);
